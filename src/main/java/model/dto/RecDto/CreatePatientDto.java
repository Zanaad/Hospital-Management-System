...
public class CreatePatientDto
{
    ...
    public CreatePatientDto(String PfirstName, String PlastName, java.sql.Date Pbirthdate, String Pphone, String Pemail, String Paddress, java.sql.Date Pdate, int Ppayment) {
